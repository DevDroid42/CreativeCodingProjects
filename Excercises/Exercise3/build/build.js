...
class Shape {
    constructor(position, speed, shape) {
        this.position = position;
        this.speed = speed;
        this.shape = shape;
    }
    tick() {
        this.speed.add(createVector((noise(this.position.x * noiseScale + t, this.position.y * noiseScale + t) - 0.5) * 100 * (0.5 + fft.getEnergy(50, 10000)), (noise(this.position.x * noiseScale + t, this.position.y * noiseScale + t + 10) - 0.5) * 100 * (0.5 + fft.getEnergy(50, 10000))).mult(fft.getEnergy('bass') * 0.01));
